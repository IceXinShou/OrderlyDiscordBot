...
import com.ice.main.util.EmojiUtil;
import com.ice.main.util.GuildUtil;
import com.ice.main.util.QuestionStep;
...
import static com.ice.main.BotSetting.configFolder;
import static com.ice.main.BotSetting.joinRoleID;
...
*/
     ...
     * 回覆導向 (反應)
     */
    public void onPrivateMessageReactionAdd(MessageReactionAddEvent event) {
