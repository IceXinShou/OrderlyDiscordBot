...
import static main.command.list.Invite.authChannel;
import static main.command.list.Invite.authChannelID;
import static main.event.InformationReaction.internalRole;
import static main.event.InformationReaction.logRole;
import static main.event.Log.*;
import static main.lang.LangKey.*;
import static main.util.GuildUtil.guildID;
import static main.util.SlashCommandOption.*;
