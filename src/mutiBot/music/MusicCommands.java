...
public class MusicCommands implements GuildMusicManager.Event {
    ...
    public MessageEmbed[] playStatus(Member member, TrackScheduler scheduler) {
        ...
        if (scheduler.playingTrack != null) {
            ...
            JSONObject urlInfo = new JSONObject(TrackScheduler.getUrlData("https://www.googleapis.com/youtube/v3/videos?id=" +
...
// \d+:\d+ +[\S ]+
                    ...
                    new StringBuilder()
                            .append(" \uD83D\uDC40 ")
                            .append(String.format("%,d", statistics.getInt("viewCount")))
                            .append(" | \uD83D\uDC4D ").append(String.format("%,d", statistics.getInt("likeCount")))
                            .append(" | \uD83D\uDC4E ").append(String.format("%,d", statistics.getInt("dislikeCount")))
                            .append(" | \uD83D\uDCAC ").append(String.format("%,d", statistics.getInt("commentCount")))
